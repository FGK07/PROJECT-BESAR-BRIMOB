            ...
            <div class="space-y-4 border-r border-gray-200 pr-6">
                ...
                <div>
                    ...
                    <select name="kategori_id" required
                        class="w-full border border-gray-300 rounded-md px-3 py-2 bg-white focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="5"
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500"></textarea>
                </div>

                <div>
                    <label class="block text-gray-700 font-medium mb-1">Teks Banner</label>
                    <textarea name="teks_banner" rows="2"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 resize-none"></textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="gambar" accept=".jpg,.jpeg,.png,.gif,.webp" required
                        class="w-full border border-gray-300 rounded-md px-3 py-2 bg-white text-sm focus:ring-2 focus:ring-blue-500">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-end gap-3 pt-6">
                    <a href="<?= htmlspecialchars($backUrl) ?>"
                        class="w-1/2 bg-gray-400 text-white py-2 rounded-md hover:bg-gray-500 text-sm text-center font-medium shadow">
                        ← Kembali
                    </a>
                    <button type="submit"
                        class="w-1/2 bg-black text-white py-2 rounded-md hover:bg-gray-800 text-sm font-medium shadow flex justify-center items-center gap-2">
